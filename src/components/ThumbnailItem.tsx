    ...
    >
      ...
      >
        ...
        <div
          ...
          className={`${styles.thumbnailFilenameOverlay} position-absolute bottom-0 start-0 end-0 bg-dark bg-opacity-75 text-white p-2`}
        >
        ...
        <button
          ...
          type="button"
          className={`${styles.removeButton} btn btn-danger btn-sm position-absolute top-0 end-0 m-2 rounded-circle d-flex align-items-center justify-content-center`}
